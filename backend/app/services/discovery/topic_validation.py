def validate_topic(topic: str):
    ...
    validation_summary = (
        ...
        f"The topic appears to be "
        f"{specificity.lower()} "

        f"and belongs primarily to the "
        f"{research_field} domain. "

        f"Further literature analysis is required "
        f"to evaluate research novelty and "
        f"research gaps."
